...
export const metadata: Metadata = pageMetadata({
  title: "Insights on Humanitarian Cash & Voucher Assistance | HCVA",
  description:
    "Analysis and practical perspectives on humanitarian cash, digital payments, preparedness, responsible data and CVA in Nepal and South Asia.",
  path: "/insights",
});

export default function InsightsPage() {
  const [lead, ...rest] = insights;
  return <><BreadcrumbJsonLd items={[{ name: "Home", path: "/" }, { name: "Insights", path: "/insights" }]} /><InternalHeader /><main className="insights-page">
