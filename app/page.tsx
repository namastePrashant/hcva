    ...
    <main>
      <header className="site-header" onMouseLeave={() => setMegaOpen(false)}>
        ...
        <div className={`mega-menu ${megaOpen ? "open" : ""}`}>
          ...
          <div className="mega-column"><span>Knowledge</span><a href="/learning" onClick={() => setMegaOpen(false)}><b>Resource library</b><small>19 curated courses, tools & reports</small></a><a href="/learning" onClick={() => setMegaOpen(false)}><b>Practice areas</b><small>Markets, data, payments, protection & more</small></a><a href="/insights" onClick={() => setMegaOpen(false)}><b>HCVA Insights</b><small>Original analysis and sector perspectives</small></a></div>
      ...
      <div className={`mobile-menu ${mobileOpen ? "open" : ""}`}>
        ...
        <a href="/learning" onClick={() => setMobileOpen(false)}>Knowledge hub <span>03</span></a>
